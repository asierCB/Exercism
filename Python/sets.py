...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    lista_ingredientes = (dish_name, ingredientes)
...
def tag_special_ingredients(dish):
    ...
    """
    plato, ingredientes = dish
    listado_set = set()
    for ingrediente in ingredientes:
        if ingrediente in SPECIAL_INGREDIENTS:
            listado_set.add(ingrediente)
    return (plato, listado_set)
...
def compile_ingredients(dishes):
    ...
    """
    listado_set = set()
    for comidas in dishes:
        for ingrediente in comidas:
            listado_set.add(ingrediente)
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    lista_sin_aperitivos = list()
    for plato in set(dishes):
        if plato not in appetizers:
            lista_sin_aperitivos.append(plato)
    return lista_sin_aperitivos

    #return lis(set(dishes) - set(appetizers))
